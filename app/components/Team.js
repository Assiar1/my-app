  ...
  return (
	...
	<div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
		...
		<div className="flex flex-row flex-wrap justify-center mt-8">
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-52 bg-custom-pink  dark:bg-white-800 dark:text-gray-100">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://www.futwiz.com/assets/img/fifa18wc/faces/20801.png" />
				<div className="flex-1 my-4 text-black">
				...
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2 border-black">
					...
					<a rel="noopener noreferrer" href="#" title="Twitter" className="dark:text-gray-50 hover:dark:text-violet-600">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" className="w-5 h-5 text-black">
					...
					<a rel="noopener noreferrer" href="#" title="LinkedIn" className="dark:text-gray-50 hover:dark:text-violet-600">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 text-black">
			...
			</div><div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-52 bg-custom-pink  dark:bg-white-800 dark:text-gray-100">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://www.futwiz.com/assets/img/fifa18wc/faces/20801.png" />
				<div className="flex-1 my-4 text-black">
					<p className="text-xl font-semibold leading-snug">Leroy Jenkins</p>
					<p>Visual Designer</p>
